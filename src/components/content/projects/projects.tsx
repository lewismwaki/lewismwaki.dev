            ...
            <Box position='relative'>
              <Box position='relative' overflow='clip'>
                ...
                >
                  ...
                  <Center>
                    <Box width='215px' height='226px' zIndex='10'>
                      <>
                        {projectTag == 0 ? (
                          <StaticImage
                  ...
                  <Flex direction='row'>
                    ...
                    <>
                      <Flex direction='column' alignItems='center' zIndex='20'>
                        <Flex direction='row'>
                          {projectTag == 0 ? (
                  ...
                  {/* projects  controller */}
                  <Center>
                    <Box width='335px' position='relative' zIndex='10'>
                      {/* bkg */}
                      <StaticImage
                        src='../../../images/mobile_projects_controller.png'
                        alt=''
                      />
